 ...
 */
  ...
  #elif ENABLED(PARK_HEAD_ON_PAUSE) && DISABLED(SDSUPPORT) && ENABLED(NEWPANEL) && DISABLED(EMERGENCY_PARSER)
 ...
 * ULTIPANEL encoder
 */
#if DISABLED(ULTIPANEL) && ENABLED(NEWPANEL) && DISABLED(SR_LCD_2W_NL) && !defined(SHIFT_CLK)
